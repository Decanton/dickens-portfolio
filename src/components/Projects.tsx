...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      outcome:
        "Reinforced back-end skills in file management, CLI interactions, and application logic through an end-to-end mini-platform.",
    ...
    },
    {
      ...
      outcome:
        "Enabled a complete buying experience with admin tools for product and user management, supporting both buyers and sellers. Demonstrated capabilities in React, Node.js, and MongoDB stack.",
      icon: <ShoppingCart className="w-6 h-6" />,
      tags: ["React", "Node.js", "MongoDB", "REST API", "Admin Panel"],
      gradient: "from-yellow-500 to-orange-500",
      github: "https://github.com/Decanton/ecommerce-platform", // replace if needed
      live: "https://ecommerce.dickensowuor.dev" // optional
    }
  ];
